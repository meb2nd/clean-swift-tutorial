...
class CreateOrderViewControllerTests: XCTestCase {
    ...
    func testShouldShowOrderToEditWhenViewIsLoaded()
    {
        ...
        loadView()
        // Then
        XCTAssert(createOrderBusinessLogicSpy.showOrderToEditCalled,
                  "Should show order to edit when the view is loaded")
    }
    ...
    func testShouldDisplayOrderToEdit() {
        ...
        let viewModel = CreateOrder.EditOrder.ViewModel(orderFormFields: CreateOrder.OrderFormFields(firstName: orderToEdit.firstName, lastName: orderToEdit.lastName, phone: orderToEdit.phone,
            email: orderToEdit.email, billingAddressStreet1: orderToEdit.billingAddress.street1,
            billingAddressStreet2: orderToEdit.billingAddress.street2 ?? "",
            billingAddressCity: orderToEdit.billingAddress.city, billingAddressState: orderToEdit.billingAddress.state,
            ...
            id: orderToEdit.id, date: orderToEdit.date, total: orderToEdit.total))
    ...
    func testCreateOrderFailureShouldShowAnAlert() {
        ...
        sut.displayCreatedOrder(viewModel: viewModel)
        // Then
        let alertController = TestDisplaySaveOrderFailure.viewControllerToPresent
