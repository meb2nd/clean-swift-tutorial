...
class CreateOrderInteractorTests: XCTestCase {
    ...
    func testCreateOrderShouldAskOrdersWorkerToCreateTheNewOrderAndPresenterToFormatIt() {
        ...
        let request = CreateOrder.CreateOrder.Request(orderFormFields:
            CreateOrder.OrderFormFields(firstName: "", lastName: "", phone: "",
                                        email: "", billingAddressStreet1: "", billingAddressStreet2: "",
                                        ...
                                        shipmentAddressStreet1: "", shipmentAddressStreet2: "", shipmentAddressCity: "",
                                        shipmentAddressState: "", shipmentAddressZIP: "", shipmentMethodSpeed: 0,
                                        shipmentMethodSpeedString: "", id: "some id", date: Date(),
                                        total: NSDecimalNumber(string: "9.99")))
    ...
    func testUpdateOrderShouldAskOrdersWorkerToUpdateTheExistingOrderAndPresenterToFormatIt() {
        ...
        sut.ordersWorker = ordersWorkerSpy
        // When
        let request = CreateOrder.UpdateOrder.Request(orderFormFields:
            CreateOrder.OrderFormFields(firstName: "", lastName: "", phone: "",
                                        email: "", billingAddressStreet1: "", billingAddressStreet2: "",
                                        billingAddressCity: "", billingAddressState: "", billingAddressZIP: "",
                                        paymentMethodCreditCardNumber: "", paymentMethodCVV: "",
