...
class CreateOrderPresenterTests: XCTestCase {
    ...
    class CreateOrderDisplayLogicMock: CreateOrderDisplayLogic {
        ...
        func verifyEditOrderViewModelOrderFormFields(order: Order) -> Bool {
            ...
            return editOrderViewModel.orderFormFields.firstName == order.firstName &&
                ...
                editOrderViewModel.orderFormFields.billingAddressStreet1 ==
                order.billingAddress.street1 &&
                editOrderViewModel.orderFormFields.billingAddressStreet2 ==
                order.billingAddress.street2 &&
                editOrderViewModel.orderFormFields.billingAddressCity ==
                order.billingAddress.city &&
                editOrderViewModel.orderFormFields.billingAddressState ==
                ...
                editOrderViewModel.orderFormFields.shipmentAddressStreet1
                == order.shipmentAddress.street1 &&
                editOrderViewModel.orderFormFields.shipmentAddressStreet2
                == order.shipmentAddress.street2 &&
                editOrderViewModel.orderFormFields.shipmentAddressCity ==
                order.shipmentAddress.city &&
                editOrderViewModel.orderFormFields.shipmentAddressState ==
                order.shipmentAddress.state &&
                editOrderViewModel.orderFormFields.shipmentAddressZIP ==
                order.shipmentAddress.zip &&
                editOrderViewModel.orderFormFields.shipmentMethodSpeed ==
                order.shipmentMethod.speed.rawValue &&
    ...
    func testPresentOrderToEditShouldFormatTheExistingOrderForDisplayUsingSpy() {
        ...
        dateFormatter.dateStyle = .short
        dateFormatter.timeStyle = .none
        let orderPaymentMethodExpirationDate =
            dateFormatter.string(from: order.paymentMethod.expirationDate)
        ...
        XCTAssertEqual(createOrderDisplayLogicSpy.editOrderViewModel.orderFormFields.billingAddressCity, order.billingAddress.city,
                       "Presenting the order to edit should format the existing order")
        ...
        XCTAssertEqual(createOrderDisplayLogicSpy.editOrderViewModel.orderFormFields.billingAddressZIP, order.billingAddress.zip,
                       "Presenting the order to edit should format the existing order")
    ...
    func testPresentOrderToEditShouldFormatTheExistingOrderForDisplayUsingMock() {
        ...
        sut.presentOrderToEdit(response: response)
        // Then
        XCTAssert(createOrderDisplayLogicMock.displayOrderToEditCalled,
                  "Presenting the order to edit should ask view controller to display it")
